...
func NewPtolemaiosConfig(schema OdysseiaApi, ca []byte) (*PtolemaiosImpl, error) {
	client := NewHttpClient(ca, schema.Cert)
	return &PtolemaiosImpl{Scheme: schema.Scheme, BaseUrl: schema.Url, Client: client}, nil
}
